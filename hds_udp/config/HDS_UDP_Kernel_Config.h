...
#define HDS_UDP_DEFAULT_MAX_WINDOWS_SIZE ((unsigned long)-1) /*TODO 这个值是多少？*/

//定义最大的包大小
#define MAX_UDP_PACKET_SIZE 1472
#define HDS_UDP_PACKET_MAX_HEADER_LENGTH 20
#define HDS_UDP_PACKET_MAX_DATA_LENGTH (MAX_UDP_PACKET_SIZE-HDS_UDP_PACKET_MAX_HEADER_LENGTH) /*1450*/
...
#ifdef linux
#define LIMIT_500_US_SEND_SEPPD MAX_UDP_PACKET_SIZE*4  //byte /*microsecond（μs）；五百微妙 发送多少字节 这样的一个速度？*/
#endif



 //定义最大连接数目。必须是power of 2
#define HDS_UDP_CONNECTION_MARK_BITS 20 /*掩码？*/
#define HDS_UDP_MAX_CONNECTION_COUNT (1<<HDS_UDP_CONNECTION_MARK_BITS)
#define HDS_UDP_CONNECTION_OFFSET_SHIRT ((1<<HDS_UDP_CONNECTION_MARK_BITS)-1) /*TODO 这个是干啥？*/
...
#define HDS_UDP_CONNECTION_MAX_SUSPEND_TIME 1000 /*暂停*/
