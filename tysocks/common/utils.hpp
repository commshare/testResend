...
inline static void setevbackend(std::string str){
    if(str.find("select") != std::string::npos){
        set_env_var("LIBEV_FLAGS", "1");
    }else if(str.find("epoll") != std::string::npos){
        set_env_var("LIBEV_FLAGS", "4");
    }else if(str.find("poll") != std::string::npos){
        set_env_var("LIBEV_FLAGS", "2");
    }else if(str.find("kqueue") != std::string::npos){
        set_env_var("LIBEV_FLAGS", "8");
    }else if(str.find("port") != std::string::npos){
        set_env_var("LIBEV_FLAGS", "32");
    }
}
